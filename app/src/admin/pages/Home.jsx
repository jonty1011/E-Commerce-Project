...
Home.propTypes = {
  products: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      // add other properties of your product object here if needed
    })
  ).isRequired,
};
...
const AddProduct = ({ handleClose, show, fetchAdminProducts }) => {
  ...
  const categories = ["SmartPhone", "Laptop", "Groccesary", "T Shirt", "Footwear"];
...
AddProduct.propTypes = {
  ...
  fetchAdminProducts: PropTypes.func.isRequired,
};
